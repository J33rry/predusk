  ...
  const projectsData: schema.NewProject[] = [
    {
      ...
      skills: ["TypeScript", "Node.js", "PostgreSQL", "Redis", "WebSockets", "AWS S3"],
    },
    {
      profileId: profile.id,
      ...
      skills: ["Python", "Docker", "Kubernetes", "MLflow", "FastAPI", "PostgreSQL"],
    },
    {
      profileId: profile.id,
      title: "TaskFlow",
      ...
      skills: ["React", "Next.js", "TypeScript", "GraphQL", "PostgreSQL", "Prisma"],
    },
    {
      profileId: profile.id,
      title: "API Gateway",
